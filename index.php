...
// Overridujeme dvě konkrétní spodní sekce (DB-driven)
// 1) "Alabarte – Toskánsko v každé lahvi" -> nový obsah (Firemní klienti)
// 2) "Fattoria La Torre" -> skryjeme celou sekci (zmizí i druhý obrázek)
